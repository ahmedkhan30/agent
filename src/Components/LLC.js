...
const data = [
  {
    img:'https://www.clevver.io/wp-content/themes/Clevvers/images/icons/icon-main-company.svg',
    top: "LET US FORM YOUR",
    middle: "Registered Agent",
    bottom: "INSTANT SERVICE",
  },
  {
    img:'https://www.clevver.io/wp-content/themes/Clevvers/images/icons/icon-main-banking.svg',
    top: "LET US FORM YOUR",
    middle: "Form an LLC",
    bottom: "INSTANT SERVICE",
  },
  {
    img:'https://www.clevver.io/wp-content/themes/Clevvers/images/icons/icon-main-tax-accounting.svg',
    top: "LET US FORM YOUR",
    middle: "Form a Non LLC",
    bottom: "INSTANT SERVICE",
  },
  {
    img:'https://www.clevver.io/wp-content/themes/Clevvers/images/icons/icon-main-address.svg',
    top: "LET US FORM YOUR",
  ...
  {
    img:'https://www.clevver.io/wp-content/themes/Clevvers/images/icons/icon-main-number.svg',
    top: "LET US FORM YOUR",
    middle: "Form an C Corporation",
    bottom: "INSTANT SERVICE",
  }
